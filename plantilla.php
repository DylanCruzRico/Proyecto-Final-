...
<?php 
    if(isset($_SESSION["Ingresar"]) && $_SESSION["Ingresar"] == true) {
        ...
        if(isset($_GET["url"])){
            ...
            if($url[0] == "inicio" || $url[0] == "salir" || $url[0] == "mis-datos" || $url[0] == "Carreras" || $url[0] == "Editar-Carrera" || $url[0] == "Editar-Inicio" || $url[0] =="Crear-Materias" || $url[0] == "Materias" || $url[0] == "Plan-de-Estudios" || $url[0] == "insc-materia"){
