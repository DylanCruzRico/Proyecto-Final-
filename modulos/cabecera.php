<header class="main-header">
    <!-- Logo -->
    <a href="http://localhost/universidad/Vistas/inicio" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b class="fa fa-university" style="font-size 25px; color: black;"></b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="http://localhost/universidad/Vistas/img/logo.png"  class="img-responsive" alt=""></span>
    </a>
              ...
              <li class="user-header" style="height: 100px;">
                <?php 
                  if($_SESSION["rol"] == "Administrador"){
                    ...
                    echo '<p> 
                      '.$_SESSION["apellido"]." ".$_SESSION["nombre"].' - Usuario: '.$_SESSION["usuario"].';
                    </p>';
                    ...
                    $resp = $carrerasC->VerCarreras2C($columna, $valor);

                    echo '<p>'.$resp["nombre"].'</p>';
                  }
                ?>
              </li>
              <!-- Menu Footer-->
